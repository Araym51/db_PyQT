...
Клиентский модуль приложения для обмена сообщениями.
...
Поддерживаются аргументы коммандной строки:
...
* ``python client_app.py ip_address some_port``
...
* ``python client.py ip_address some_port -n ara -p 1``

*Запуск приложения с пользователем ara и паролем 1 и указанием подключаться к серверу по адресу ip_address:port*

client.py
~~~~~~~~~

Запускаемый модуль, функцию чтения аргументов командной строки и функционал инициализации приложения.
