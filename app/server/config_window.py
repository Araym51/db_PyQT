...
class ConfigWindow(QDialog):
    """отображение окна настроек сервера"""
    ...
    def save_server_config(self):
        '''
        Метод для сохранения настроек. Проверяет правильность введённых данных.
        Если всё правильно сохраняет настройки в ini файл.
        '''
